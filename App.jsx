...
export default function SOCIETYxSHOP() {
  ...
  useEffect(() => {
    ...
    socket.on('productSold', (data) => {
      ...
      // สั่งให้ React อัปเดตตัวเลขใน state products ทันที
      setProducts((prevProducts) => 
        prevProducts.map((product) => 
          // ถ้าเจอสินค้าตัวที่ตรงกับที่เพิ่งขายไป ให้เอาเลขยอดขายใหม่ไปแทนที่
    ...
    // 🟢 ล้างการเชื่อมต่อเมื่อผู้ใช้ปิดหน้าเว็บ
    return () => {
